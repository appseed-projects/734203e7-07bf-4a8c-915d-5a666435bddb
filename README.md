...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-10-11 09:33`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/734203e7-07bf-4a8c-915d-5a666435bddb.git
$ cd 734203e7-07bf-4a8c-915d-5a666435bddb
```
